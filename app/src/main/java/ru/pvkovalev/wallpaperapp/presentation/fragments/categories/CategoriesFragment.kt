...
import ru.pvkovalev.wallpaperapp.presentation.adapters.CategoryAdapter
...
class CategoriesFragment : Fragment() {
    ...
    private fun initRecyclerView() {
        ...
        recyclerViewAdapter.onItemClick = {
            val action =
                MainFragmentDirections.actionMainFragmentToSpecificCategoryFragment(it.categoryName)
