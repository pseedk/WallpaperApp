...
import ru.pvkovalev.wallpaperapp.ui.fragments.MainFragmentDirections

class RecyclerViewAdapter : PagingDataAdapter<ResponseUnsplashPhoto, RecyclerViewAdapter.MyViewHolder>(DiffUtilCallback) {
